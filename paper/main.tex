...
We now proceed with the detailed specification of clause gadget \(C^i\) (see Figure \ref{fig:org4c8ec8f}).

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{../assets/Screen Shot 2023-02-14 at 15.07.03.png}
\caption{\label{fig:org4c8ec8f}Clause gadget \(C^i\)}
\end{figure}
...
We now proceed with the detailed specification of variable gadget \(X^j\) (see Figure \ref{fig:org776fd37}).

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{../assets/Screen Shot 2023-02-14 at 15.06.35.png}
\caption{\label{fig:org776fd37}Variable gadget \(X^j\)}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org8fd7a39}All (\(s,t\))-flows}
\centering
\begin{tabular}{ll}
Flow & (\(s,t\))-path\\[0pt]
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org8237aad}All blocks grouped by flow pair}
\centering
\begin{tabular}{lll}
...
\caption{\label{fig:orgb6b2d61}Flow pair \(\tilde{F}\) in update flow network \(\tilde{G}\)}
\end{figure}
